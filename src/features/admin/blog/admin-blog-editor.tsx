          ...
          <CardContent className="space-y-6">
            ...
            {preview ? (
              <article className="space-y-5 rounded-2xl border border-tk-line bg-tk-surface-2 p-6">
                ...
                <div className="whitespace-pre-wrap text-base leading-8 text-tk-ink">{form.content || "Conteúdo ainda não preenchido."}</div>
              ...
              <div className="grid items-start gap-5 md:grid-cols-2">
                ...
                <div className="md:col-span-2"><Textarea label="Conteúdo" value={form.content} onChange={(event) => updateField("content", event.target.value)} className="min-h-[360px]" hint="HTML e scripts não são permitidos. Use texto simples ou Markdown seguro." /></div>
